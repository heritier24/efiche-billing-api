...
class PatientAnalyticsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'group_by' => 'nullable|in:acquisition_source,age_group,visit_type',
    ...
    public function messages(): array
    {
        return [
            ...
            'group_by.in' => 'Group by must be one of: acquisition_source, age_group, visit_type',
